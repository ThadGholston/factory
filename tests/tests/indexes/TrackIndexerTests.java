...
public class TrackIndexerTests {
	...
	public void testFilterOnIntervalAndLocationDoesNotReturnWhenIntersectingSpatialButNotTemporalAR()
		...
		int[] yArr2 = { 1, 1, 2, 2 };
		Polygon poly = new Polygon(xArr2, yArr2, xArr2.length);
		ArrayList<ITrack> retList = idxr.search(itvl2,
				poly);
		assertTrue(retList.size() == 0);
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void testBasicTrackSearchDoesNotReturnWhenNotIntersectingSpatialAR()
            throws IllegalArgumentException {
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void testBasicTrackSearchDoesNotReturnWhenNotIntersectingSpatialSG()
            throws IllegalArgumentException {
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void testBasicTrackSearchDoesReturnWhenIntersectingSpatialTemporalAR()
            throws IllegalArgumentException {
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void testBasicTrackSearchDoesReturnWhenIntersectingSpatialTemporalSG()
            throws IllegalArgumentException {
