 ...
 * Author: Dustin
 *
 * Created on January 20, 2014, 1:23 PM
 */

#ifndef COSTGRAPH_HPP
#define	COSTGRAPH_HPP
...
struct CostGraph {
    ...
    typedef adjacency_list < vecS, vecS, directedS, no_property, property < 
		edge_capacity_t, long, property < edge_residual_capacity_t, long, 
		property < edge_reverse_t, Traits::edge_descriptor, property <edge_weight_t, long>>>>> Graph;
